...
export class AgentPipeline {
  ...
  async previewPrompt(chapter = 1) {
    ...
    const { loadOutline } = await import('../kg/kg-reader.js');
    ...
    const context = {
      characters: this.kg.characters || '',
      factions: this.kg.factions || '',
      locations: this.kg.locations || '',
      worldRules: this.kg.worldRules || '',
      style: this.kg.style || '',
      constraints: this.kg.constraints || '',
