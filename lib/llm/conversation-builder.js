...
static createWriterTemplate() {
    return new ConversationBuilder()
      ...
      // 极简 prompt
      .userTemplate('Write chapter {{chapterNum}}. Outline: {{outline}}. Characters: {{characters}}. IMPORTANT: Start with exactly "Chapter {{chapterNum}}" as the title (not Chapter 1, not any other number). Then write the story content. Word count requirement: 2500-3500 characters.', ['chapterNum', 'outline', 'characters'], { name: 'Task' })
