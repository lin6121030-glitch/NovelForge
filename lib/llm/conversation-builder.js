...
export class TemplateFactory {
  ...
  static createWriterTemplate(adapterType = 'openai') {
    if (adapterType === 'minimax') {
      return new ConversationBuilder()
        .system('你是一个专业的小说作家，具备上下文记忆能力。请记住所有提供的世界观、角色、情节信息，用于后续创作。', { name: '系统设定' })
        
        .userTemplate('请创作第{{chapterNum}}章。\n\n## 大纲\n{{outline}}\n\n## 角色\n{{characters}}\n\n## 场景\n{{locations}}\n\n请基于以上信息创作，注意保持一致性。', ['chapterNum', 'outline', 'characters', 'locations'], { name: '任务' })
        
        .build('MiniMax Writer Agent 模板', 'MiniMax专用小说创作模板');
    }
    
    return new ConversationBuilder()
      .system('你是一个小说作家。', { name: '系统设定' })
      
      .userTemplate('请创作第{{chapterNum}}章。{{outline}} {{characters}}', ['chapterNum', 'outline', 'characters'], { name: '任务' })
